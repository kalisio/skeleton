import{_ as s,c as a,o as i,V as n}from"./chunks/framework.Q5AHJ25T.js";const p="/skeleton/assets/hooks-diagram-template.SHLdfxGX.png",u=JSON.parse('{"title":"Documentation","description":"","frontmatter":{},"headers":[],"relativePath":"guides/development/documentation.md","filePath":"guides/development/documentation.md"}'),t={name:"guides/development/documentation.md"},l=n(`<h1 id="documentation" tabindex="-1">Documentation <a class="header-anchor" href="#documentation" aria-label="Permalink to &quot;Documentation&quot;">​</a></h1><p>The approach we have adopted rely on <a href="https://vitepress.dev/" target="_blank" rel="noreferrer">VitePress</a> to generate the static web site of your app.</p><h2 id="install-vitepress" tabindex="-1">Install VitePress <a class="header-anchor" href="#install-vitepress" aria-label="Permalink to &quot;Install VitePress&quot;">​</a></h2><p>You first need to install vitepress:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">$yarn add -D vitepress</span></span></code></pre></div><p>And then add the documentation generation scripts to the <code>package.json</code> file:</p><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;scripts&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: {</span></span>
...
<span class="line"><span>        { text: &#39;Publish your app&#39;, link: &#39;/guides/development/publish&#39; },</span></span>
...
<span class="line"><span>        { text: &#39;Tips &amp; troubleshooting&#39;, link: &#39;/guides/development/tips&#39; }</span></span>
<span class="line"><span>      ]</span></span>
<span class="line"><span>    },</span></span>
<span class="line"><span>    {</span></span>
...
<span class="line"><span>        { text: &#39;Manage collection&#39;, link: &#39;/guides/howtos/collection&#39; },</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">        env</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">          SOPS_AGE_KEY</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">\${{ secrets.SOPS_AGE_KEY }}</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">        run</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">bash ./scripts/build_docs.sh -p -r \${{ github.job }}</span></span></code></pre></div></details><h2 id="working-with-diagrams" tabindex="-1">Working with diagrams <a class="header-anchor" href="#working-with-diagrams" aria-label="Permalink to &quot;Working with diagrams&quot;">​</a></h2><p>We use two distinct tools to work with diagrams:</p><ul><li><a href="http://draw.io" target="_blank" rel="noreferrer">draw.io</a> a complete editor to create well known diagrams</li><li><a href="https://github.com/knsv/mermaid" target="_blank" rel="noreferrer">mermaid</a> which allows you to generate diagrams from a simple text definition. We mainly use mermaid to create the hooks diagrams.</li></ul><p>To be able to include the diagrams within the documentation, we adopted the following methodology:</p><h3 id="draw-io" tabindex="-1">Draw.io <a class="header-anchor" href="#draw-io" aria-label="Permalink to &quot;Draw.io&quot;">​</a></h3><ol><li>make it with <a href="http://draw.io" target="_blank" rel="noreferrer">draw.io</a> and store it in this folder</li><li>export it as SVG/PNG in the root <strong>assets</strong> folder</li><li>reference it in the documentation using a link like this <code>![My legend](https://raw.githubusercontent.com/kalisio/kdk/master/images/my-diagram.png)</code></li></ol><h3 id="mermaid" tabindex="-1">mermaid <a class="header-anchor" href="#mermaid" aria-label="Permalink to &quot;mermaid&quot;">​</a></h3><ol><li>install the <a href="https://github.com/mermaidjs/mermaid.cli" target="_blank" rel="noreferrer">mermaid CLI</a></li><li>start from the hooks diagram template file</li></ol><details class="details custom-block"><summary>.github/workflows/main.yaml</summary><div class="language-mmd vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">mmd</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>graph TB</span></span>
<span class="line"><span>    beforeAll{before all}</span></span>
<span class="line"><span>    bahook(ba-hook) --&gt; beforeAll</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    afterAll{after all}</span></span>
<span class="line"><span>    afterAll --&gt; aahook(aa-hook)</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    beforeAll --&gt; bfhook(bf-hook)</span></span>
<span class="line"><span>    bfhook --&gt;|before| FIND[FIND]</span></span>
<span class="line"><span>    FIND --&gt;|after| afhook(af-hook)</span></span>
<span class="line"><span>    afhook --&gt; afterAll</span></span>
<span class="line"><span>    </span></span>
<span class="line"><span>    beforeAll --&gt; bghook(bg-hook)</span></span>
<span class="line"><span>    bghook --&gt;|before| GET[GET]</span></span>
<span class="line"><span>    GET --&gt;|after| aghook(ag-hook)</span></span>
<span class="line"><span>    aghook --&gt; afterAll</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    beforeAll --&gt; bchook(bc-hook)</span></span>
<span class="line"><span>    bchook --&gt;|before| CREATE[CREATE]</span></span>
<span class="line"><span>    CREATE --&gt;|after| achook(ac-hook)</span></span>
<span class="line"><span>    achook --&gt; afterAll</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    beforeAll --&gt; buhook(bu-hook)</span></span>
<span class="line"><span>    buhook --&gt;|before| UPDATE[UPDATE]</span></span>
<span class="line"><span>    UPDATE --&gt;|after| auhook(au-hook)</span></span>
<span class="line"><span>    auhook --&gt; afterAll</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    beforeAll --&gt; bphook(bp-hook)</span></span>
<span class="line"><span>    bphook --&gt;|before| PATCH[PATCH]</span></span>
<span class="line"><span>    PATCH --&gt;|after| aphook(ap-hook)</span></span>
<span class="line"><span>    aphook --&gt; afterAll</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    beforeAll --&gt; brhook(br-hook)</span></span>
<span class="line"><span>    brhook --&gt;|before| REMOVE[REMOVE]</span></span>
<span class="line"><span>    REMOVE --&gt;|after| arhook(ar-hook)</span></span>
<span class="line"><span>    arhook --&gt; afterAll</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    linkStyle default stroke-width:2px,fill:none,stroke:black</span></span>
<span class="line"><span>    classDef hookClass fill:#f96,stroke:#333,stroke-width:2px</span></span>
<span class="line"><span>    class bahook,aahook,bfhook,afhook,bghook,aghook,bchook,achook,buhook,auhook,bphook,aphook,brhook,arhook hookClass</span></span>
<span class="line"><span>    classDef operationClass fill:#9c6,stroke:#333,stroke-width:2px</span></span>
<span class="line"><span>    class FIND,GET,CREATE,UPDATE,PATCH,REMOVE operationClass</span></span></code></pre></div></details><ol start="3"><li>output the SVG/PNG file in the root <strong>assets</strong> folder using <code>mmdc -i ./my-hooks-diagram.mmd -t neutral -b transparent -o my-hooks-diagram.svg</code></li><li>reference it in the documentation using a link like this <code>![My legend](https://raw.githubusercontent.com/kalisio/kdk/master/images/my-diagram.png)</code></li></ol><p>The template looks like this: <img src="`+p+'" alt="Hooks Diagram Template"></p>',32),e=[l];function h(k,r,o,E,d,g){return i(),a("div",null,e)}const y=s(t,[["render",h]]);export{u as __pageData,y as default};
